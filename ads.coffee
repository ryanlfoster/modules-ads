do ($ = jQuery, window) ->
    ...
    #
    # USE:
    #  <div class="advertisement" data-ad-options='{"site_name": "ngc", "zone": "American Weed", "width": "300", "height": "600" }>
    #  </div>
    #
        ...
        init: (options) ->
            ...
            return @.each () ->
                ...
                if not data
                    ...
                    $.fn[module].$refreshables.push this if opts.refreshable
                    ...
                    $(window).on 'stateChange', (e) ->
                        ...
                        $.fn[module].timer = window.setTimeout ->
                            $refreshables.ads()
                        , 500
    ...
    $.fn[module] = ( method ) ->
        if methods[method]
            ...
            $.error "Method #{ method } does not exist on jQuery.#{ module }"

    $.fn[module].$refreshables = $()
    $.fn[module].timer = undefined